...
dt.fixbat <- find.bad.models.f("/users/peter/Documents/baseball/analysis/umpires/models.batter")
if(nrow(dt.fixbat) > 0) {
  fix.bad.models.f("/users/peter/Documents/baseball/analysis/umpires/models.batter")
